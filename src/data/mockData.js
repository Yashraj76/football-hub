...
export const teams = [
  {
    ...
    gradientColor: 'linear-gradient(135deg, #ff6b35, #e63946)',
    founded: '2019',
    homeGround: 'Phoenix Arena',
    captain: 'player-1',
    manager: 'Carlos Rivera',
    description: 'Rising from the ashes, Phoenix FC brings fiery passion to every match.',
    emoji: '🔥',
    playerCount: 15,
    wins: 18,
    draws: 4,
  ...
  },
  {
    ...
    founded: '2018',
    homeGround: 'Thunder Park',
    captain: 'player-4',
    manager: 'James Wilson',
    description: 'The thunder never strikes twice — except in our attack.',
    emoji: '⚡',
    playerCount: 14,
    wins: 15,
    draws: 5,
  ...
  },
  {
    ...
    gradientColor: 'linear-gradient(135deg, #2d6a4f, #40916c)',
    founded: '2020',
    homeGround: 'Serpent Ground',
    captain: 'player-7',
    manager: 'David Okonkwo',
    description: 'Quick, cunning, and lethal — the Vipers strike with precision.',
    emoji: '🐍',
    playerCount: 13,
    wins: 12,
    draws: 7,
  ...
  },
  {
    ...
    gradientColor: 'linear-gradient(135deg, #e9c46a, #e76f51)',
    founded: '2017',
    homeGround: 'Lions Den',
    captain: 'player-10',
    manager: 'Ahmad Hassan',
    description: 'The pride of the league — majestic and unstoppable.',
    emoji: '🦁',
    playerCount: 14,
    wins: 20,
    draws: 3,
  ...
  },
  {
    ...
    gradientColor: 'linear-gradient(135deg, #6c757d, #343a40)',
    founded: '2021',
    homeGround: 'Wolf Valley',
    captain: 'player-13',
    manager: 'Max Sterling',
    description: 'Silent but deadly. The Wolves hunt in packs.',
    emoji: '🐺',
    playerCount: 12,
    wins: 10,
    draws: 6,
  ...
  },
  {
    ...
    gradientColor: 'linear-gradient(135deg, #dc2626, #991b1b)',
    founded: '2019',
    homeGround: 'Dragon Fortress',
    captain: 'player-16',
    manager: 'Lee Joon-ho',
    description: 'Breathing fire on every pitch they play.',
    emoji: '🐉',
    playerCount: 13,
    wins: 14,
    draws: 4,
...
export const tournaments = [
  {
    ...
    endDate: '2026-10-30',
    status: 'ongoing',
    description: 'The ultimate summer showdown. All 6 teams battle it out in a league format.',
  ...
  },
  {
    ...
    endDate: '2026-05-15',
    status: 'completed',
    description: 'Single elimination knockout tournament with dramatic finishes.',
    teams: ['team-1', 'team-2', 'team-3', 'team-4', 'team-5', 'team-6'],
    totalMatches: 5,
    matchesPlayed: 5,
    winner: 'team-4',
  ...
  },
  {
    ...
    endDate: '2027-03-30',
    status: 'upcoming',
    description: 'Brace for the cold. The winter league promises heated rivalries.',
    teams: ['team-1', 'team-2', 'team-3', 'team-4', 'team-5', 'team-6'],
    totalMatches: 30,
    matchesPlayed: 0,
    emoji: '❄️',
...
// Helper: get top assists
export function getTopAssists(limit = 5) {
  return [...players].sort((a, b) => b.stats.assists - a.stats.assists).slice(0, limit);
}

// Helper: get recent matches
...
// Helper: position full name
export function getPositionFull(pos) {
...
export const platformStats = {
  ...
  totalGoals: matches.filter(m => m.status === 'completed').reduce((sum, m) => sum + (m.homeScore || 0) + (m.awayScore || 0), 0),
};
